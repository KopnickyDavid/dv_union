            ...
            for k, collect in pairs(Config.Locations.Collect) do
                ...
                if rob then
                    ...
                    if #(player - Config.Locations.Hack) < Config.textdistance and hacked == false then
                        sleep = false
                        Draw3DText(Config.Locations.Hack.x, Config.Locations.Hack.y, Config.Locations.Hack.z,
                            Config.DrawTexts[5])
                        if IsControlJustReleased(0, 38) then
                    ...
                    if #(player - Config.Locations.Escape.TextCoords) < Config.textdistance then
                        sleep = false
                        Draw3DText(Config.Locations.Escape.TextCoords.x, Config.Locations.Escape.TextCoords.y,
                            Config.Locations.Escape.TextCoords.z, Config.DrawTexts[1])
                        if IsControlJustReleased(0, 38) then
                            SetEntityCoords(ped, Config.Locations.Escape.TeleportCoords.x,
                                Config.Locations.Escape.TeleportCoords.y, Config.Locations.Escape.TeleportCoords.z, false,
                                false, false, false)
                ...
                if #(player - Config.Locations.Teleports.Up) < Config.textdistance then
                    sleep = false
                    Draw3DText(Config.Locations.Teleports.Up.x, Config.Locations.Teleports.Up.y,
                        Config.Locations.Teleports.Up.z, Config.DrawTexts[3])
                    if IsControlJustReleased(0, 38) then
                        SetEntityCoords(ped, Config.Locations.Teleports.Down.x,
                            Config.Locations.Teleports.Down.y, Config.Locations.Teleports.Down.z, false,
                            false, false, false)
                    end
                end
                if #(player - Config.Locations.Teleports.Down) < Config.textdistance then
                    sleep = false
                    Draw3DText(Config.Locations.Teleports.Down.x, Config.Locations.Teleports.Down.y,
                        Config.Locations.Teleports.Down.z, Config.DrawTexts[2])
                    if IsControlJustReleased(0, 38) then
                        SetEntityCoords(ped, Config.Locations.Teleports.Up.x,
                            Config.Locations.Teleports.Up.y, Config.Locations.Teleports.Up.z, false,
                            false, false, false)
                    end
                end
